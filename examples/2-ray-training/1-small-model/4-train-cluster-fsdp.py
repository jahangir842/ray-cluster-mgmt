"""
PyTorch Fully Sharded Data Parallel (FSDP2) with Ray Train
Source: https://github.com/ray-project/ray (official Ray example)

Train a Vision Transformer (ViT) on FashionMNIST using FSDP2 and Ray Train.
"""
